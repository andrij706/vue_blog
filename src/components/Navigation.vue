<script setup>
    ...
    import barsRegular from '../assets/Icons/barsRegular.svg'
    ...
    onMounted(() => {
        screenResize.value = window.addEventListener('resize', checkScreen)
        checkScreen()
    })
...
<template>
    <header>
                ...
                <div v-if="user" @click="toggleProfileMenu" class="profile" ref="profile">
                  ...
                  <div v-show="profileMenu" class="profile-menu">
                    ...
                    <div class="options">
                      ...
                      <div @click="signOutProfile" class="option">
        ...
        <barsRegular @click="toggleMobileNav" v-show="mobile" class="menu-icon"/>
